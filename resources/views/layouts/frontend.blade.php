                ...
                <div class="navbar navbar-expand-lg navbar-light">
                    <div class="container">
                        <a class="navbar-brand d-none d-sm-block flex-shrink-0" href="{{ route('frontend.home') }}">
                            <img src="{{ asset('public/1.png') }}" width="145px" />
                        </a>
                        ...
                        <div class="input-group d-none d-lg-flex mx-4" >
                            <input class="form-control rounded-end pe-5" type="text" name="key" placeholder="{{__('lang.timkiem')}}" />
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="languageDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ url('lang/cn') }}">China</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                            ...
                            <a class="navbar-tool ms-1 ms-lg-0 me-n1 me-lg-2" href="{{ route('user.dangnhap') }}">
                                ...
                                <div class="navbar-tool-text ms-n3"><small>{{__('lang.xinchao')}}</small>{{__('lang.khachhang')}}</div>
                            </a>
                            @else
                            <a class="navbar-tool ms-1 ms-lg-0 me-n1 me-lg-2" href="{{ route('user.home') }}">
                                <div class="navbar-tool-icon-box"><i class="navbar-tool-icon ci-user"></i></div>
                                <div class="navbar-tool-text ms-n3"><small>{{__('lang.xinchao')}}</small>{{Auth::user()->name }}</div>
                            </a>
                            @endguest                     
                            <div class="navbar-tool ms-3">
                                ...
                                <a class="navbar-tool-text" href="{{ route('frontend.giohang') }}"><small>{{__('lang.giohang')}}</small></a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link ps-lg-0" href="{{ route('frontend.home') }}">
                                        <i class="ci-home me-2"></i>@lang('lang.trangchu')
                                    </a>
                                </li>
                            </ul>
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link ps-lg-0" href="{{ route('frontend.sanpham') }}">
                                        <i class="ci-gift me-2"></i>{{__('lang.sanpham')}}
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('frontend.baiviet') }}"><i class="ci-globe me-2"></i>{{__('lang.baiviet')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('frontend.tuyendung') }}"><i class="ci-loudspeaker me-2"></i>{{__('lang.tuyendung')}}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('frontend.lienhe') }}"><i class="ci-support me-2"></i>{{__('lang.lienhe')}}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <footer class="footer bg-dark">
        <div class="pt-5 bg-darker">
            <div class="container">
                <div class="row pb-2">
                    <div class="col-md-6 text-center text-md-start mb-4">
                        <div class="text-nowrap mb-4">
                            <a class="d-inline-block align-middle mt-n1 me-3" href="{{ route('frontend.home') }}"><img class="d-block" src="{{ asset('public/1.png') }}" width="117" /></a>
                        </div>
                        <div class="widget widget-links widget-light">
                            <ul class="widget-list d-flex flex-wrap justify-content-center justify-content-md-start">
                                <li class="widget-list-item me-5"><a class="widget-list-link" href="{{ route('frontend.home') }}">@lang('lang.trangchu')</a></li>
                                <li class="widget-list-item me-5"><a class="widget-list-link" href="{{ route('frontend.sanpham') }}">{{__('lang.sanpham')}}</a></li>
                                <li class="widget-list-item me-5"><a class="widget-list-link" href="{{ route('frontend.baiviet') }}">{{__('lang.baiviet')}}</a></li>
                                <li class="widget-list-item me-5"><a class="widget-list-link" href="{{ route('frontend.tuyendung') }}">{{__('lang.tuyendung')}}</a></li>
                                <li class="widget-list-item me-5"><a class="widget-list-link" href="{{ route('frontend.lienhe') }}">{{__('lang.lienhe')}}</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">{{__('lang.banquyen')}} &copy; {{ date('Y') }} {{__('lang.boi')}} {{ config('app.name', 'Laravel') }}.</div>
            </div>
        </div>
    </footer>
