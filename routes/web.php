...
Route::name('frontend.')->group(function() { 
    ...
    Route::get('/chi-tiet/{tensanpham_slug}',[HomeController::class,'detail'])->name('sanpham.chitiet');
...
Route::post('/one_payment', [KhachHangController::class,'one_payment'])->name('one_payment');
Route::post('/momo_payment', [KhachHangController::class,'momo_payment'])->name('momo_payment');
